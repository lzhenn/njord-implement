...
ocn_ra= '/home/lzhenn/drv_field//hycom_subset/2010072112/';
...
wdr = '/home/lzhenn/drv_field//icbc/2010072112/';
...
roms_swan_grid_dir = '/disk/r074/lzhenn/workspace/njord_pipeline/njord-implement/domaindb/njord/';
...
[gn, clm]=get_ijrg_hcast([ocn_ra,'hycom.grid.nc'], modelgrid, theta_s, theta_b, Tcline, N, Vtransform, Vstretching);

% Call to create the climatology (clm) file
disp('going to create clm file')
fn=updatclim_coawst_mw_local_hcast(T1, gn, clm, 'coawst_clm.nc', wdr, ocn_ra)
...
if numdays>1
    ...
    for it=dayFrequency:dayFrequency:numdays-1      %1st day already created, NEED to set number of days at top!
        ...
        fn=updatclim_coawst_mw_local_hcast(T1+it,gn,clm,fname,wdr,ocn_ra)
